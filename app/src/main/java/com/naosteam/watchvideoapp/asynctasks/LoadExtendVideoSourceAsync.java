...
public class LoadExtendVideoSourceAsync extends AsyncTask<Void, String, Boolean> {
    ...
    public LoadExtendVideoSourceAsync(Bundle bundle, Methods methods, LoadSearchVideoAsyncListener listener) {
            ...
            switch (bundle.getString("type")){
                case "dailymotion":
                    ...
                    for (int i = 0; i < jsonArray.length(); i++){
                        ...
                        mVideos.add(methods.getDailymotionVideo(obj));
                    }
